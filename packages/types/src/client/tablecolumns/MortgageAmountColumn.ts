    ...
    [TableType.INVESTMENT_BREAKDOWN_TABLE]: {
        sortFunction: (
            ...
            return sort(
                ...
                monthlyInvestmentDetails => InvestmentDetailsTableHelper.getMortgageAmount(monthlyInvestmentDetails),
                sortDirection
            );
        },
        value: (monthlyInvestmentDetails: MonthlyInvestmentDetailsResponseDTO): PrimitiveType => {
            return InvestmentDetailsTableHelper.getMortgageAmount(monthlyInvestmentDetails);
        }
    }
};