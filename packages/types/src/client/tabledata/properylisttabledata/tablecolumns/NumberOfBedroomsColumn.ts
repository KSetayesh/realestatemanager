...
export class NumberOfBedroomsColumn extends TableColumn<ListingWithScenariosResponseDTO, PropertyColumnAccessorEnum> {
    ...
    private _title: string = NUMBER_OF_BEDROOMS;
    private _accessor: PropertyColumnAccessorEnum = PropertyColumnAccessorEnum.NUMBER_OF_BEDROOMS;
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return TableHelper.getListingDetails(listingWithScenarios).propertyDetails.numberOfBedrooms;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = TableHelper.getListingDetails(a).propertyDetails.numberOfBedrooms;
            const bValue = TableHelper.getListingDetails(b).propertyDetails.numberOfBedrooms;
