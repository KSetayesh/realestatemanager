...
export abstract class TableColumn<Y> {
    ...
    protected abstract tableColumnDetails: TableColumnDetailsType;
    ...
    get title(): string {
        return this.tableColumnDetails.title;
    }

    get accessor(): string {
        return this.tableColumnDetails.accessor;
    }

    get inputType(): InputType {
        return this.tableColumnDetails.inputType;
    }

    get isUrl(): boolean {
        return this.tableColumnDetails.isUrl;
    }

    get isDollarAmount(): boolean {
        return this.tableColumnDetails.isDollarAmount;
    }

    get addSuffix(): string {
        return this.tableColumnDetails.addSuffix;
    }
