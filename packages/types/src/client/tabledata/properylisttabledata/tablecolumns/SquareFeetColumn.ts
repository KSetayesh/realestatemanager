...
import { SQUARE_FEET } from "../../TableTitles";

export class SquareFeetColumn extends TableColumn<ListingWithScenariosResponseDTO, PropertyColumnAccessorEnum> {

    private _title: string = SQUARE_FEET;
