...
import { TableColumnDetailsEnum } from "../../TableTitles";
...
export type TableColumnsMapType<Y> = TableColumn<Y>;

export type PropertiesListColumnsType<Y> = {
    [key in TableColumnDetailsEnum]: TableColumn<Y>;//TableColumnsMapType<ListingWithScenariosResponseDTO>
};

// export const propertiesListColumnsMap: PropertiesListColumnsType<ListingWithScenariosResponseDTO> = {
//     [TableColumnDetailsEnum.PROPERTY_TYPE]: new PropertyTypeColumn(),
//     [TableColumnDetailsEnum.FULL_ADDRESS]: new FullAddressColumn(),
//     [TableColumnDetailsEnum.STATE]: new StateColumn(),
//     [TableColumnDetailsEnum.ZIP_CODE]: new ZipCodeColumn(),
//     [TableColumnDetailsEnum.ZILLOW_URL]: new ZillowUrlColumn(),
//     [TableColumnDetailsEnum.PRICE]: new PriceColumn(),
//     [TableColumnDetailsEnum.RENT_ESTIMATE]: new RentEstimateColumn(),
//     [TableColumnDetailsEnum.INITIAL_COSTS]: new InitialCostsColumn(),
//     [TableColumnDetailsEnum.LOAN_AMOUNT]: new LoanAmountColumn(),
//     [TableColumnDetailsEnum.DOWN_PAYMENT_AMOUNT]: new DownPaymentAmountColumn(),
//     [TableColumnDetailsEnum.ANNUAL_INTEREST_RATE]: new AnnualInterestRateColumn(),
//     [TableColumnDetailsEnum.ROI]: new ROIColumn(),
//     [TableColumnDetailsEnum.CAP_RATE]: new CapRateColumn(),
//     [TableColumnDetailsEnum.RECURRING_COSTS]: new RecurringCostsColumn(),
//     [TableColumnDetailsEnum.INITIAL_MONTHLY_AMOUNT]: new InitialMonthlyAmountColumn(),
//     [TableColumnDetailsEnum.MORTGAGE]: new MortgageColumn(),
//     [TableColumnDetailsEnum.MONTHLY_CASH_FLOW]: new MonthlyCashFlowColumn(),
//     [TableColumnDetailsEnum.YEARLY_CASH_FLOW]: new YearlyCashFlowColumn(),
//     [TableColumnDetailsEnum.NUMBER_OF_DAYS_ON_MARKET]: new NumberOfDaysOnMarketColumn(),
//     [TableColumnDetailsEnum.DATE_LISTED]: new DateListedColumn(),
//     [TableColumnDetailsEnum.DATE_CREATED]: new DateCreatedColumn(),
//     [TableColumnDetailsEnum.CITY]: new CityColumn(),
//     [TableColumnDetailsEnum.COUNTY]: new CountyColumn(),
//     [TableColumnDetailsEnum.COUNTRY]: new CountryColumn(),
//     [TableColumnDetailsEnum.STREET_ADDRESS]: new StreetAddressColumn(),
//     [TableColumnDetailsEnum.APARTMENT_NUMBER]: new ApartmentNumberColumn(),
//     [TableColumnDetailsEnum.LONGITUDE]: new LongitudeColumn(),
//     [TableColumnDetailsEnum.LATITUDE]: new LatitudeColumn(),
//     [TableColumnDetailsEnum.ELEMENTARY_SCHOOL_RATING]: new ElementarySchoolRatingColumn(),
//     [TableColumnDetailsEnum.MIDDLE_SCHOOL_RATING]: new MiddleSchoolRatingColumn(),
//     [TableColumnDetailsEnum.HIGH_SCHOOL_RATING]: new HighSchoolRatingColumn(),
//     [TableColumnDetailsEnum.NUMBER_OF_BEDROOMS]: new NumberOfBedroomsColumn(),
//     [TableColumnDetailsEnum.NUMBER_OF_FULL_BATHROOMS]: new NumberOfFullBathroomsColumn(),
//     [TableColumnDetailsEnum.NUMBER_OF_HALF_BATHROOMS]: new NumberOfHalfBathroomsColumn(),
//     [TableColumnDetailsEnum.SQUARE_FEET]: new SquareFeetColumn(),
//     [TableColumnDetailsEnum.ACRES]: new AcresColumn(),
//     [TableColumnDetailsEnum.YEAR_BUILT]: new YearBuiltColumn(),
//     [TableColumnDetailsEnum.HAS_GARAGE]: new HasGarageColumn(),
//     [TableColumnDetailsEnum.HAS_POOL]: new HasPoolColumn(),
//     [TableColumnDetailsEnum.HAS_BASEMENT]: new HasBasementColumn(),
//     [TableColumnDetailsEnum.LISTING_PRICE]: new ListingPriceColumn(),
//     [TableColumnDetailsEnum.ZESTIMATE]: new ZestimateColumn(),
//     [TableColumnDetailsEnum.ZILLOW_RENT_ESTIMATE]: new ZillowRentEstimateColumn(),
//     [TableColumnDetailsEnum.ZESTIMATE_RANGE_LOW]: new ZestimateRangeLowColumn(),
//     [TableColumnDetailsEnum.ZESTIMATE_RANGE_HIGH]: new ZestimateRangeHighColumn(),
//     [TableColumnDetailsEnum.ZILLOW_MONTHLY_PROPERTY_TAX_AMOUNT]: new ZillowMonthlyPropertyTaxAmountColumn(),
//     [TableColumnDetailsEnum.ZILLOW_MONTHLY_HOME_INSURANCE_AMOUNT]: new ZillowMonthlyHomeInsuranceAmountColumn(),
//     [TableColumnDetailsEnum.ZILLOW_MONTHLY_HOA_FEES_AMOUNT]: new ZillowMonthlyHOAFeesColumn(),
//     [TableColumnDetailsEnum.CREATION_TYPE]: new CreationTypeColumn(),
//     [TableColumnDetailsEnum.DESCRIPTION]: new DescriptionColumn(),
// };



export const propertyTableColumnsList: TableColumn<ListingWithScenariosResponseDTO>[] = [
    new PropertyTypeColumn(),
    new FullAddressColumn(),
    new StateColumn(),
    new ZipCodeColumn(),
    new ZillowUrlColumn(),
    new PriceColumn(),
    new RentEstimateColumn(),
    new InitialCostsColumn(),
    new LoanAmountColumn(),
    new DownPaymentAmountColumn(),
    new AnnualInterestRateColumn(),
    new ROIColumn(),
    new CapRateColumn(),
    new RecurringCostsColumn(),
    new InitialMonthlyAmountColumn(),
    new MortgageColumn(),
    new MonthlyCashFlowColumn(),
    new YearlyCashFlowColumn(),
    new NumberOfDaysOnMarketColumn(),
    new DateListedColumn(),
    new DateCreatedColumn(),
    new CityColumn(),
    new CountyColumn(),
    new CountryColumn(),
    new StreetAddressColumn(),
    new ApartmentNumberColumn(),
    new LongitudeColumn(),
    new LatitudeColumn(),
    new ElementarySchoolRatingColumn(),
    new MiddleSchoolRatingColumn(),
    new HighSchoolRatingColumn(),
    new NumberOfBedroomsColumn(),
    new NumberOfFullBathroomsColumn(),
    new NumberOfHalfBathroomsColumn(),
    new SquareFeetColumn(),
    new AcresColumn(),
    new YearBuiltColumn(),
    new HasGarageColumn(),
    new HasPoolColumn(),
    new HasBasementColumn(),
    new ListingPriceColumn(),
    new ZestimateColumn(),
    new ZillowRentEstimateColumn(),
    new ZestimateRangeLowColumn(),
    new ZestimateRangeHighColumn(),
    new ZillowMonthlyPropertyTaxAmountColumn(),
    new ZillowMonthlyHomeInsuranceAmountColumn(),
    new ZillowMonthlyHOAFeesColumn(),
    new CreationTypeColumn(),
