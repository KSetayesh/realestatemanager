...
export class InitialMonthlyAmountColumn extends TableColumn {
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getInitialInvestmentDetails(listingWithScenarios).transactions.Mortgage.breakdown.amount;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            // Come back to this --> initialInvestmentDetails(a).transactions.Mortgage.breakdown.amount;
            const aValue = this.getInitialInvestmentDetails(a).transactions.Mortgage.breakdown.amount;
            const bValue = this.getInitialInvestmentDetails(b).transactions.Mortgage.breakdown.amount;
