...
export class ZestimateRangeHighColumn extends TableColumn {
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getListingDetails(listingWithScenarios).zillowMarketEstimates.zestimateRange.high;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getListingDetails(a).zillowMarketEstimates.zestimateRange.high;
            const bValue = this.getListingDetails(b).zillowMarketEstimates.zestimateRange.high;
