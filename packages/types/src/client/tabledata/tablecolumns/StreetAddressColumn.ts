...
export class StreetAddressColumn extends TableColumn {
    ...
    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getListingDetails(a).propertyDetails.address.streetAddress;
            const bValue = this.getListingDetails(b).propertyDetails.address.streetAddress;
