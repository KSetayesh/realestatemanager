...
export class ZillowMonthlyHomeInsuranceAmountColumn extends TableColumn {
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getListingDetails(listingWithScenarios).zillowMarketEstimates.zillowMonthlyHomeInsuranceAmount;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getListingDetails(a).zillowMarketEstimates.zillowMonthlyHomeInsuranceAmount;
            const bValue = this.getListingDetails(b).zillowMarketEstimates.zillowMonthlyHomeInsuranceAmount;
