...
export class FullAddressColumn extends TableColumn {
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getListingDetails(listingWithScenarios).propertyDetails.address.fullAddress;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getListingDetails(a).propertyDetails.address.fullAddress;
            const bValue = this.getListingDetails(b).propertyDetails.address.fullAddress;
