...
export class DownPaymentAmountColumn extends TableColumn {
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getInitialInvestmentDetails(listingWithScenarios).transactions["Initial Expense"].breakdown["Down Payment"].amount;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getInitialInvestmentDetails(a).transactions["Initial Expense"].breakdown["Down Payment"].amount;
            const bValue = this.getInitialInvestmentDetails(b).transactions["Initial Expense"].breakdown["Down Payment"].amount;
