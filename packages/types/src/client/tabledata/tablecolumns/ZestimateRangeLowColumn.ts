...
export class ZestimateRangeLowColumn extends TableColumn {

    private _accessor: PropertyColumnAccessorEnum = PropertyColumnAccessorEnum.ZESTIMATE_RANGE_LOW;
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getListingDetails(listingWithScenarios).zillowMarketEstimates.zestimateRange.low;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getListingDetails(a).zillowMarketEstimates.zestimateRange.low;
            const bValue = this.getListingDetails(b).zillowMarketEstimates.zestimateRange.low;
