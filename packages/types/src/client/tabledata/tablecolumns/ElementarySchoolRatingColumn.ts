...
export class ElementarySchoolRatingColumn extends TableColumn {
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getListingDetails(listingWithScenarios).propertyDetails.schoolRating.elementarySchoolRating;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getListingDetails(a).propertyDetails.schoolRating.elementarySchoolRating;
            const bValue = this.getListingDetails(b).propertyDetails.schoolRating.elementarySchoolRating;
