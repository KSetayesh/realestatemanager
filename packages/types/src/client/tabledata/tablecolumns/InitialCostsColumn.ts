...
export class InitialCostsColumn extends TableColumn {
    ...
    value(listingWithScenarios: ListingWithScenariosResponseDTO): string | number | boolean {
        return this.getInitialInvestmentDetails(listingWithScenarios).transactions["Initial Expense"].totalAmount.amount;
    }

    protected _sort(listingWithScenarios: ListingWithScenariosResponseDTO[], sortDirection: SortDirection): ListingWithScenariosResponseDTO[] {
        return listingWithScenarios.sort((a, b) => {
            const aValue = this.getInitialInvestmentDetails(a).transactions["Initial Expense"].totalAmount.amount;
            const bValue = this.getInitialInvestmentDetails(b).transactions["Initial Expense"].totalAmount.amount;
