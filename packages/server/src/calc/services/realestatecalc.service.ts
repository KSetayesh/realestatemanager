...
import { InvestmentAnalysis } from "../models/investmentscenario.model";
import { ListingDetails } from "../models/listingdetails.model";



// import { AdditionalExpensesDTO, AmortizationScheduleDTO, ListingDetails, MortgageDTO, ProjectionsDTO, Utility } from "@realestatemanager/shared";
...
export class RealEstateCalculator {
    ...
    execute(listingDetails: ListingDetails) {
        return null;
    }
